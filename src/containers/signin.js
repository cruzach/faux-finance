...
class Signin extends React.Component {
    ...
    onSubmitSignin = () => {
        fetch('https://git.heroku.com/rocky-everglades-18419.git/signin', {
            method: 'post',
            ...
            .then(user => {
                if (user.id) {
                    ...
                    alert('Invalid email/password. Have you registerred yet?');
                }
            })
    }
                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="lh-copy mt3">
                            <p className="f6 pointer link dim black db " onClick={() => onRouteChange('register')}>Register</p>
                        </div>
                    </div>
                </main>
            </ article>
